...
class Task1 {
  ...
  */
   ...
   */
    ...
    var school = new List<String>.filled(_MAX_LENGHT, "",
        growable: false); // "" -> Empty string
    var reaction_time =
        new List<double>.filled(_MAX_LENGHT, 0, growable: false);
 ...
 */
  static double Average_Reaction(
      {required List<double> reaction,
  ...
  static void run(
      List<int> age, List<String> school, List<double> reaction_times) {
    /**
         * Starts Task 2
         */
